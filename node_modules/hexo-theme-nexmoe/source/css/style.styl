    ...
    .nexmoe-widget-wrap {
        ...
        .nexmoe-widget {
            ...
            .category-list-count, .archive-list-count {
                background-color: rgba(hexo-config('color.first.r'), hexo-config('color.first.g'), hexo-config('color.first.b'), 0.1);
                display: inline-block;
                width: 26px;
                height: 26px;
                line-height: 26px;
...
.nexmoe-rainbow {
    a:nth-child(7n+1) {
        background-color: $nrbgc1;
        color: $color1;
    }

    a:nth-child(7n+2) {
        background-color: $nrbgc2;
        color: $color2;
    }

    a:nth-child(7n+3) {
        background-color: $nrbgc3;
        color: $color3;
    }

    a:nth-child(7n+4) {
        background-color: $nrbgc4;
        color: $color4;
    }

    a:nth-child(7n+5) {
        background-color: $nrbgc5;
        color: $color5;
    }

    a:nth-child(7n+6) {
        background-color: $nrbgc6;
        color: $color6;
    }

    a:nth-child(7n+7) {
        background-color: $nrbgc7;
        color: $color7;
    }
}
...
.nexmoe-rainbow-fill {
    a:nth-child(7n+1) {
        color: #fff;
        background-color: $nrfbgc1;
    }

    a:nth-child(7n+2) {
        color: #fff;
        background-color: $nrfbgc2;
    }

    a:nth-child(7n+3) {
        color: #fff;
        background-color: $nrfbgc3;
    }

    a:nth-child(7n+4) {
        color: #fff;
        background-color: $nrfbgc4;
    }

    a:nth-child(7n+5) {
        color: #fff;
        background-color: $nrfbgc5;
    }

    a:nth-child(7n+6) {
        color: #fff;
        background-color: $nrfbgc6;
    }

    a:nth-child(7n+7) {
        color: #fff;
        background-color: $nrfbgc7;
    }
}